...
<!-- Content Header (Page header) -->
    <section class="content-header">
      ...
      Bidang Penunjang Lainnya
        <small>Data Bidang Penunjang Lainnya</small>
      </h1>
      <ol class="breadcrumb">
        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              ...
              <a href="{{ route('penunjang.create') }}" class="btn btn-success"><i class="fa fa-plus-circle"></i> Bidang Penunjang Lainnya</a>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
...
<script>
  $(document).ready(function() {
      $('#table').DataTable({
          ...
          serverSide: true,
          timeout: 500,
          ajax: "{{ route('datatable.penunjang_asesor') }}",
          columns: [
