...
<section class="content-header">
    <h1>
        ...
        <small>Tambah Bidang Penunjang Lainnya</small>
    </h1>
    <ol class="breadcrumb">
    ...
    <div class="row">
        <div class="col-xs-12">
            <div class="box box-primary">
                ...
                <!-- /.box-header -->
                <!-- form start -->
                <form role="form" method="POST" action="{{ route('penunjang.store') }}" enctype="multipart/form-data">
                    @csrf
                    <div class="box-body">
                        <div class="row">
                            <div class="col-sm-6">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <select
                                        ...
                                        <option>Pilih</option>
                                        <option value="A">Menjadi Anggota dalam suatu Panitia/Badan pada Perguruan Tinggi</option>
                                        ...
                                        <option value="E">Menjadi Anggota Delegasi Nasional ke Pertemuan Internasional</option>
                                        <option value="F">Berperan Serta Aktif dalam Pertemuan Ilmiah</option>
                                        <option value="G">Mendapat Penghargaan/Tanda Jasa</option>
                                        <option value="H">Menulis Buku Pelajaran SMTA ke bawah yang diterbitkan dan diedarkan Secara Nasional</option>
                                        <option value="I">Mempunyai Prestasi di Bidang Olahraga/Humaniora</option>
                                        <option value="J">Keanggotaan dalam Organisasi Profesi Dosen</option>
                                        <option value="K">Keanggotaan dalam Tim Penilaian</option>
