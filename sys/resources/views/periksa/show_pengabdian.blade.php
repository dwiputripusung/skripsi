                    ...
                    <div class="box-body">
                        <div class="row">
                            ...
                            <div class="col-sm-7">
                                ...
                                {
                                $jenis = 'Menduduki Jabatan Pimpinan';
                                } elseif($data->jenis_kegiatan == 'B')
                                {
                                $jenis = 'Melaksanakan Pengembangan Hasil Pendidikan dan Penelitian';
                                } elseif($data->jenis_kegiatan == 'C')
                                {
                                $jenis = 'Memberi Latihan/Penyuluhan/Penataran/Ceramah pada Masyarakat';
                                } elseif($data->jenis_kegiatan == 'D')
                                {
                                $jenis = 'Memberi Pelayanan Kepada Masyarakat atau Kegiatan Lain yang Menunjang Pelaksanaan Tugas Umum Pemerintah';
                                } elseif($data->jenis_kegiatan == 'E')
                                {
                                $jenis = 'Membuat/Menulis Karya Pengabdian';
                                } 
