...
<script>
    $(document).ready(function () {
        $('#table_pendidikan').DataTable({
            ...
            serverSide: true,
            timeout: 500,
            ajax: "{{ route('datatable.pendidikan_belum') }}",
            columns: [{
                    data: 'DT_RowIndex',
                    name: 'DT_RowIndex'
                },
        ...
        $('#table_penelitian').DataTable({
            ...
            serverSide: true,
            timeout: 500,
            ajax: "{{ route('datatable.penelitian_belum') }}",
            columns: [{
                    data: 'DT_RowIndex',
                    name: 'DT_RowIndex'
                },
        ...
        $('#table_pengabdian').DataTable({
            ...
            serverSide: true,
            timeout: 500,
            ajax: "{{ route('datatable.pengabdian_belum') }}",
            columns: [{
                    data: 'DT_RowIndex',
                    name: 'DT_RowIndex'
                },
        ...
        $('#table_penunjang').DataTable({
            ...
            serverSide: true,
            timeout: 500,
            ajax: "{{ route('datatable.penunjang_belum') }}",
            columns: [{
                    data: 'DT_RowIndex',
                    name: 'DT_RowIndex'
                },
