...
<section class="content-header">
    <h1>
        Bidang Penelitian
        <small>Tambah Bidang Penelitian</small>
    </h1>
    <ol class="breadcrumb">
        ...
        <div class="col-xs-12">
            <div class="box box-primary">
                <div class="box-header with-border">
                    <h3 class="box-title">Data Bidang Penelitian</h3>
                </div>
                <!-- /.box-header -->
                <!-- form start -->
                <form role="form" method="POST" action="{{ route('penelitian.store') }}" enctype="multipart/form-data">
                    @csrf
                    <div class="box-body">
                        <div class="row">
                            <div class="col-sm-6">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <select
                                        ...
                                        <option value="E">Membuat Rancangan dan Karya Teknologi, Rancangan dan Karya Seni Monumental/Seni, Pertunjukan/Karya Sastra</option>
