                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <select
                                        ...
                                        <option value="B">Melaksanakan Pengembangan Hasil Pendidikan dan Penelitian
                                        </option>
                                        <option value="C">Memberi Latihan/Penyuluhan/Penataran/Ceramah pada Masyarakat
                                        </option>
                                        <option value="D">Memberi Pelayanan Kepada Masyarakat atau Kegiatan Lain yang
