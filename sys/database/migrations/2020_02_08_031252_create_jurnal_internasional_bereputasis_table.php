...
class CreateJurnalInternasionalBereputasisTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('jurnal_internasional_bereputasis', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('jurnal_internasional_bereputasis');
    }
}
